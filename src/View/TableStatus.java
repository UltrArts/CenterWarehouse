...
public class TableStatus extends JLabel{
    ...
    public TableStatusType getType() {
        return type;
    }

    
    private TableStatusType type;     
    public void setType(TableStatusType type){
        this.type = type;
